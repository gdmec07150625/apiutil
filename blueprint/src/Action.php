...
class Action extends Section
{
     ...
     *
     * @var \Apiutil\Blueprint\RestResource
     */
    protected $resource;
    ...
    public function getAuthors () {
        if ($annotation = $this->getAnnotationByType('Authors')) {
            return $annotation;
        }
    }
     ...
     *
     * @return \Apiutil\Blueprint\Annotation\Versions|null
     */
     ...
     *
     * @return \Apiutil\Blueprint\Annotation\Response|null
     */
     ...
     *
     * @return \Apiutil\Blueprint\Annotation\Request|null
     */
     ...
     *
     * @return \Apiutil\Blueprint\Annotation\Transaction|null
     */
